...
export class DefaultService {
    ...
    protected basePath = 'https://localhost:3000/v1';
     ...
     */
    public createUser(requestBody: UserCreationRequest, observe?: 'body', reportProgress?: boolean): Observable<User>;
    public createUser(requestBody: UserCreationRequest, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<User>>;
    public createUser(requestBody: UserCreationRequest, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<User>>;
    public createUser(requestBody: UserCreationRequest, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
